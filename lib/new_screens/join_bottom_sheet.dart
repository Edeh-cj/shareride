                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                          (x.participants.length == 7)? 'Complete!' : x.participants.length == 6? '1 passenger remaining': '${7-x.participants.length} passengers remaining' ,
                    ...
                    child: GestureDetector(
                      onTap: () async{
                        ...
                        await context.read<RidesProvider>().joinRide(  
                          alarmTime: context.read<ServiceTimeProvider>().getAlarmSchedule(widget.ride.time),            
                          ride: widget.ride, 
                      ...
                      child: AppButton(label: 'Join @ ${x.price}', state: buttonState, height: 40.h,)),
                  ),
                ],
              )
            ],
